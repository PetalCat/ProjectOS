...
Run:
```bash
cd /Users/parker/Developer/ProjectOS
...
cp -r /tmp/projectos-scaffold/* /Users/parker/Developer/ProjectOS/
cp /tmp/projectos-scaffold/.gitignore /Users/parker/Developer/ProjectOS/
...
```bash
cd /Users/parker/Developer/ProjectOS/src-tauri
...
```bash
cd /Users/parker/Developer/ProjectOS/src-tauri && cargo build
cd /Users/parker/Developer/ProjectOS
